    ...
    return (
        ...
        <div>
            ...
            {roomsDummyData.map((room) => (
                <div key={room._id} className='flex flex-col md:flex-row items-start py-2 px-2 gap-6 border-gray-300 last:pb-10 last:border-3 '>
                    <img onClick={() => {navigate(`/rooms/${room._id}`), scrollTo(0,0)}} src= {room.images[0]} alt="hotel-img" title='View Rooms Details' className='max-h-65 
                    md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
